...
def default_score_config():
    ...
    agent_a_type = "ppo2"  # type supported by rlproj.policies.loader
    agent_a_path = "model.pkl"  # path or other unique identifier
    agent_b_type = "ppo2"  # type supported by rlproj.policies.loader
    agent_b_path = "model.pkl"  # path or other unique identifier
